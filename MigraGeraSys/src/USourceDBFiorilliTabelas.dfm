inherited frmSourceDBFiorilliTabelas: TfrmSourceDBFiorilliTabelas
  Caption = 'SourceDB Fiorilli - Tabelas'
  ClientHeight = 629
  ClientWidth = 1041
  OnCreate = FormCreate
  ExplicitWidth = 1047
  ...
  inherited pnlTitulo: TPanel
    Width = 1035
    Caption = ' Lista de tabelas da base Fiorilli'
    ExplicitWidth = 1035
  end
  ...
  object qryTabelaDB: TFDQuery
    Connection = frmSourceDBFiorilli.fdSourceDB
    Transaction = frmSourceDBFiorilli.fdTransSourceDB
    UpdateTransaction = frmSourceDBFiorilli.fdTransSourceDB
    Left = 243
    Top = 215
  end
end
